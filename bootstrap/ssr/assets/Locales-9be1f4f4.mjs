  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (["admin", "super admin"].includes((_b = (_a = _ctx.$page.props.auth) == null ? void 0 : _a.user) == null ? void 0 : _b.type)) {
        ...
        _push(ssrRenderComponent(unref(Link), {
          href: _ctx.route("admin.story"),
          class: ["hover:font-bold", {
            "text-zinc-700 hover:text-zinc-800": props.dark,
            "underline  font-bold": _ctx.route().current("admin.story")
          }]
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(_ctx.trans("words.story"))}`);
            } else {
              return [
                createTextVNode(toDisplayString(_ctx.trans("words.story")), 1)
              ];
            }
          }),
          _: 1
