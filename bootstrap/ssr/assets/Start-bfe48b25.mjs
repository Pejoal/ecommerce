    ...
    const pass = () => {
      ...
      for (const item of lastItems) {
        for (const card of props.userCards[page.auth.user.id]) {
          if ((card == null ? void 0 : card.order) + 1 == (item == null ? void 0 : item.order) && (card == null ? void 0 : card.group_card_id) == (item == null ? void 0 : item.group_card_id) || (card == null ? void 0 : card.order) == 1 && !item || (card == null ? void 0 : card.order) === 0 && cards.value.some((cardArray) => cardArray.length > 0)) {
